  ...
  return (
    <div className="flex items-center justify-center h-screen text-center">
      <div className="relative w-full h-full">
        ...
        />
        <div className="absolute w-full h-full bg-background/60"></div>
      </div>
      <div className="absolute top-[25%] sm:top-[30%] w-full md:px-0 px-6">
        <div className="relative flex flex-col w-full h-full">
          <div className="relative">
            <div className="absolute top-[50%] md:translate-y-[-50%] translate-y-[-50%] left-[50%] translate-x-[-50%]">
              <div className="relative md:size-[225px] size-[225px] z-10">
                <Image
          ...
          <div className="absolute flex flex-col items-center w-full md:bottom-[15%] bottom-0 translate-y-[100%]">
